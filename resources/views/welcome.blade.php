...
<html lang="en">
  ...
  <main role="main" class="inner cover">
    <h1 class="cover-heading">TALIBON POLYTECHNIC COLLEGE</h1>
    <p class="lead">Welcome to Talibon Polytechnic College Computer Based Testing Platform, do follow instructions and goodluck in your exams.</p>
    <p class="lead">
          @if (Route::has('login'))
